        ...
        <AuthProvider>
          <CustomerProvider>
            <Routes>
              ...
              <Route
                path="/businesses/:businessId/login"
                element={
                  <AuthProvider>
                    <BusinessLoginPage />
                  </AuthProvider>
              ...
              <Route
                ...
                element={<PriceIncreaseGenerator />}
              />
              <Route
                path="/tools/service-agreement"
                element={<ServiceAgreementGenerator />}
              />
              ...
              />
              <Route
                path="/businesses/:businessId/onboard"
                element={
                  <AuthProvider>
              ...
              />
              <Route
                path="/businesses/:businessId/privacy"
                element={
                  <AuthProvider>
                    <PrivacyPolicy />
                  </AuthProvider>
              ...
              />
              <Route
                path="/businesses/:businessId/terms"
                element={
                  <AuthProvider>
                    <TermsOfService />
                  </AuthProvider>
              ...
              />
              <Route
                path="/businesses/:businessId/employees/onboard"
                element={
                  <AuthProvider>
                    <EmployeeOnboarding />
                  </AuthProvider>
